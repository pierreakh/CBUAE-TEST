...
$(document).ready(function () {
  function c(passed_month, passed_year, calNum) {
    ...
    calendar.datesBody.find(".today").css("color", "#87b633"); // find elements (dates) to be clicked on each time
    ...
    clickedElement.on("click", function () {
      ...
      if (firstClick && secondClick) {
        ...
        if (secondClickDateObj > thirdClickDateObj && thirdClickDateObj > firstClickDateObj) {
          secondClicked = thirdClicked; // then choose dates again from the start :)
      ...
      if (!firstClick) {
        ...
        secondClick = true;
        secondClicked = getClickedInfo(clicked, calendar); // what if second clicked date is before the first clicked?
  ...
  function selectDates(selected) {
    if (!$.isEmptyObject(selected)) {
      var highlightDates = function highlightDates(passed_year, passed_month, dateElements) {
  ...
  switchButton.on("click", function () {
    ...
    var generateCalendars = function generateCalendars(e) {
