...
var FullCalendar = function (e) {
  ...
  var zn = function () {
    ...
    return e.prototype.setProp = function (e, t) {
      var n, r;
      if (e in qt) console.warn("Could not set date-related prop 'name'. Use one of the date-related methods instead.");else if ("id" === e) t = Gt[e](t), this.mutate({
        standardProps: {
          publicId: t
        }
  ...
  var Jo = function () {
    ...
    return e.prototype.resetOptions = function (e, t) {
      ...
      if (m && m !== y) for (var E in m.timeZone !== y.timeZone && (d.eventSources = v.eventSources = (a = v.eventSources, s = d.dateProfile, l = v, u = s ? s.activeRange : null, Po(a, Ho(a, l), u, !0, l)), d.eventStore = v.eventStore = (e = v.eventStore, t = p.dateEnv, n = v.dateEnv, o = e.defs, i = Ue(e.instances, function (e) {
        var i = o[e.defId];
  ...
  var na = function (e) {
    ...
    return n(t, e), t.prototype.render = function () {
      ...
      for (; c < u && "body" === (l = r[c]).type;) {
        p.push(this.renderSection(l, a)), c += 1;
      }
  ...
  }, e.triggerDateSelect = In, e.unmountComponentAtNode = zr, e.unpromisify = Mr, e.version = "5.6.0", e.whenTransitionDone = $, e.wholeDivideDurations = tt, Object.defineProperty(e, "__esModule", {
    value: !0
  }), e;
}({});