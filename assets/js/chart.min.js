...
function _createForOfIteratorHelper(o, allowArrayLike) { var it = typeof Symbol !== "undefined" && o[Symbol.iterator] || o["@@iterator"]; if (!it) { if (Array.isArray(o) || (it = _unsupportedIterableToArray(o)) || allowArrayLike && o && typeof o.length === "number") { if (it) o = it; var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e62) { throw _e62; }, f: F }; } throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); } var normalCompletion = true, didErr = false, err; return { s: function s() { it = it.call(o); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e63) { didErr = true; err = _e63; }, f: function f() { try { if (!normalCompletion && it["return"] != null) it["return"](); } finally { if (didErr) throw err; } } }; }
...
!function (t, e) {
    ...
    _createClass(hn, [{
      ...
      value: function configure(t) {
        ...
        Object.getOwnPropertyNames(t).forEach(function (i) {
          ...
          var _iterator12 = _createForOfIteratorHelper(cn),
              _step12;
  ...
  function mn(t, e, i) {
    var _iterator13 = _createForOfIteratorHelper(e.getMatchingVisibleMetas("bar").reverse()),
        _step13;
  ...
  var wn = /*#__PURE__*/function () {
    ...
    _createClass(wn, [{
      ...
      value: function _resyncElements(t) {
        ...
        var _iterator15 = _createForOfIteratorHelper(e._syncList),
            _step15;
  ...
  var kn = {
    ...
    numeric: function numeric(t, e, i) {
      ...
      if (i.length > 1) {
        ...
        (_e22 < 1e-4 || _e22 > 1e15) && (o = "scientific"), s = function (t, e) {
  ...
  function Pn(t, e) {
    ...
    var c = function (t, e, i) {
      ...
      for (var _t25 = 0, _e23 = s.length - 1; _t25 < _e23; _t25++) {
        var _e24 = s[_t25];
        if (_e24 > o) return _e24;
      }
    ...
    if (s > 0) {
      ...
      var _n22 = s > 1 ? Math.round((r - a) / (s - 1)) : null;

      for (Dn(e, l, c, $(_n22) ? 0 : a - _n22, a), _t26 = 0, _i19 = s - 1; _t26 < _i19; _t26++) {
        Dn(e, l, c, o[_t26], o[_t26 + 1]);
      }

      return Dn(e, l, c, r, $(_n22) ? e.length : r + _n22), l;
    }
  ...
  var En = /*#__PURE__*/function (_Mn) {
    _inherits(En, _Mn);

    var _super3 = _createSuper(En);
    ...
    _createClass(En, [{
      ...
      value: function fit() {
        ...
        if (a) {
          ...
          if (r ? (e.width = t.maxWidth, e.height = An(s) + _a13) : (e.height = t.maxHeight, e.width = An(s) + _a13), n.display && t.ticks.length) {
            ...
            if (r) {
              var _i21 = n.mirror ? 0 : _d4 * _s16.width + _h6 * _a14.height;

              e.height = Math.min(t.maxHeight, e.height + _i21 + _l10);
            } else {
              var _i22 = n.mirror ? 0 : _h6 * _s16.width + _d4 * _a14.height;

              e.width = Math.min(t.maxWidth, e.width + _i22 + _l10);
            }

            t._calculatePadding(_i20, _o17, _d4, _h6);
          }
        }
      ...
      value: function _calculatePadding(t, e, i, n) {
        ...
        if (o.isHorizontal()) {
          ...
          "start" === s ? (_i23 = 0, _n23 = t.height) : "end" === s && (_i23 = e.height, _n23 = 0), o.paddingTop = _i23 + a, o.paddingBottom = _n23 + a;
        }
      }
    }, {
      key: "_handleMargins",
      ...
      value: function _getLabelSizes() {
        ...
        if (!e) {
          var _i24 = t.options.ticks.sampleSize;
          var _n24 = t.ticks;
          _i24 < _n24.length && (_n24 = On(_n24, _i24)), t._labelSizes = e = t._computeLabelSizes(_n24, _n24.length);
        }
      ...
      value: function getContext(t) {
        ...
        if (t >= 0 && t < i.length) {
          var _n25 = i[t];
          return _n25.$context || (_n25.$context = function (t, e, i) {
            return Object.assign(Object.create(t), {
              tick: i,
              index: e,
              type: "tick"
      ...
      value: function _computeGridLineItems(t) {
        ...
        if ("top" === a) m = p(e.bottom), v = e.bottom - h, M = m - g, S = p(t.top) + g, D = t.bottom;else if ("bottom" === a) m = p(e.top), S = t.top, D = p(t.bottom) - g, v = m + g, M = e.top + h;else if ("left" === a) m = p(e.right), y = e.right - h, w = m - g, k = p(t.left) + g, P = t.right;else if ("right" === a) m = p(e.left), k = t.left, P = p(t.right) - g, y = m + g, w = e.left + h;else if ("x" === i) {
          ...
          if ("center" === a) m = p((t.left + t.right) / 2);else if (U(a)) {
            var _t28 = Object.keys(a)[0],
                _i26 = a[_t28];
            m = p(e.chart.scales[_t28].getPixelForValue(_i26));
          }
        ...
        for (x = 0; x < c; x += O) {
          var _t29 = s.setContext(e.getContext(x)),
              _i27 = _t29.lineWidth,
              _o18 = _t29.color,
              _a15 = s.borderDash || [],
              _c11 = _t29.borderDashOffset,
              _h8 = _t29.tickWidth,
              _u2 = _t29.tickColor,
              _f = _t29.tickBorderDash || [],
              _g = _t29.tickBorderDashOffset;

          b = Tn(e, x, r), void 0 !== b && (_ = Xt(n, b, _i27), l ? y = w = k = P = _ : v = M = S = D = _, d.push({
            tx1: y,
            ty1: v,
            tx2: w,
            ty2: M,
      ...
      value: function _computeLabelItems(t) {
        ...
        if ("top" === o) w = e.bottom - g, M = e._getXAxisLabelAlignment();else if ("bottom" === o) w = e.top + g, M = e._getXAxisLabelAlignment();else if ("left" === o) {
          ...
          var _t31 = e._getYAxisLabelAlignment(u);

          M = _t31.textAlign, v = _t31.x;
        } else if ("x" === i) {
          if ("center" === o) w = (t.top + t.bottom) / 2 + f;else if (U(o)) {
            var _t32 = Object.keys(o)[0],
                _i28 = o[_t32];
            w = e.chart.scales[_t32].getPixelForValue(_i28) + f;
          }
          ...
          if ("center" === o) v = (t.left + t.right) / 2 - f;else if (U(o)) {
            var _t33 = Object.keys(o)[0],
                _i29 = o[_t33];
            v = e.chart.scales[_t33].getPixelForValue(_i29);
          }
        ...
        for (x = 0, b = r.length; x < b; ++x) {
          ...
          var _t34 = s.setContext(e.getContext(x));

          k = e.getPixelForTick(x) + s.labelOffset, S = e._resolveTickFontOptions(x), P = S.lineHeight, D = Y(y) ? y.length : 1;

          var _i30 = D / 2,
              _n26 = _t34.color,
              _l11 = _t34.textStrokeColor,
              _h9 = _t34.textStrokeWidth;

          var _u3 = void 0;

          if (a ? (v = k, C = "top" === o ? "near" === c || 0 !== p ? -D * P + P / 2 : "center" === c ? -T.highest.height / 2 - _i30 * P + P : -T.highest.height + P / 2 : "near" === c || 0 !== p ? P / 2 : "center" === c ? T.highest.height / 2 - _i30 * P : T.highest.height - D * P, d && (C *= -1)) : (w = k, C = (1 - D) * P / 2), _t34.showLabelBackdrop) {
            var _e25 = Be(_t34.backdropPadding),
                _i31 = T.heights[x],
                _n27 = T.widths[x];

            var _o19 = w + C - _e25.top,
                _s17 = v - _e25.left;
            ...
            _u3 = {
              left: _s17,
              top: _o19,
              width: _n27 + _e25.width,
              height: _i31 + _e25.height,
      ...
      value: function drawLabels(t) {
        ...
        for (s = 0, a = o.length; s < a; ++s) {
          var _t36 = o[s],
              _e26 = _t36.font,
              _n28 = _t36.label;
          _t36.backdrop && (i.fillStyle = _t36.backdrop.color, i.fillRect(_t36.backdrop.left, _t36.backdrop.top, _t36.backdrop.width, _t36.backdrop.height)), ee(i, _n28, 0, _t36.textOffset, _e26, _t36);
        }
          ...
          if (t.isHorizontal()) {
            if (f = o(n, a, l), U(i)) {
              var _t37 = Object.keys(i)[0],
                  _n29 = i[_t37];
              g = d[_t37].getPixelForValue(_n29) + m - e;
            ...
            if (U(i)) {
              var _t38 = Object.keys(i)[0],
                  _n30 = i[_t38];
              f = d[_t38].getPixelForValue(_n30) - x + e;
  ...
  var zn = new ( /*#__PURE__*/function () {
    ...
    _createClass(_class3, [{
      ...
      value: function _getRegistryForType(t) {
        for (var _e27 = 0; _e27 < this._typedRegistries.length; _e27++) {
          var _i32 = this._typedRegistries[_e27];
      ...
      value: function _notify(t, e, i, n) {
        ...
        try {
          for (_iterator16.s(); !(_step16 = _iterator16.n()).done;) {
            ...
            var _t39 = _o20.plugin;
            if (!1 === Q(_t39[i], [e, n, _o20.options], _t39) && n.cancelable) return !1;
          }
        } catch (err) {
          _iterator16.e(err);
        } finally {
  ...
  var oo = /*#__PURE__*/function () {
    function oo(t, e) {
      ...
      var c = n.platform.acquireContext(s, l.aspectRatio),
          ...
          d = h && h.height,
          u = h && h.width;
      this.id = j(), this.ctx = c, this.canvas = h, this.width = u, this.height = d, this._options = l, this._aspectRatio = this.aspectRatio, this._layers = [], this._metasets = [], this._stacks = void 0, this.boxes = [], this.currentDevicePixelRatio = void 0, this.chartArea = void 0, this._active = [], this._lastEvent = void 0, this._listeners = {}, this._responsiveListeners = void 0, this._sortedMetasets = [], this.scales = {}, this._plugins = new Fn(), this.$proxies = {}, this._hiddenIndices = {}, this.attached = !1, this._animationsDisabled = void 0, this.$context = void 0, this._doResize = i(function () {
    ...
    _createClass(oo, [{
      ...
      value: function _updateMetasets() {
        ...
        if (e.sort(function (t, e) {
          ...
          for (var _e28 = i; _e28 < n; ++_e28) {
            t._destroyDatasetMeta(_e28);
          }
      ...
      value: function update(t) {
        ...
        for (var _t43 = 0, _i35 = e.data.datasets.length; _t43 < _i35; _t43++) {
          var _e$getDatasetMeta = e.getDatasetMeta(_t43),
              _i36 = _e$getDatasetMeta.controller,
              _o24 = !n && -1 === a.indexOf(_i36);

          _i36.buildOrUpdateElements(_o24), r = Math.max(+_i36.getMaxOverflow(), r);
        }
      ...
      value: function _updateDatasets(t) {
        ...
        if (!1 !== e.notifyPlugins("beforeDatasetsUpdate", {
          ...
          for (var _n31 = 0, _o25 = e.data.datasets.length; _n31 < _o25; ++_n31) {
            e._updateDataset(_n31, i ? t({
              datasetIndex: _n31
            }) : t);
          }
      ...
      value: function draw() {
        ...
        if (t._resizeBeforeDraw) {
          var _t$_resizeBeforeDraw = t._resizeBeforeDraw,
              _e29 = _t$_resizeBeforeDraw.width,
              _i37 = _t$_resizeBeforeDraw.height;
          t._resize(_e29, _i37), t._resizeBeforeDraw = null;
        }
      ...
      value: function _drawDatasets() {
        ...
        for (var _i38 = e.length - 1; _i38 >= 0; --_i38) {
          t._drawDataset(e[_i38]);
        }
      ...
      value: function bindUserEvents() {
        var t = this,
            e = t._listeners,
            i = t.platform,
            n = function n(e, i, _n32) {
          e.offsetX = i, e.offsetY = _n32, t._eventHandler(e);
        };
      ...
      value: function bindResponsiveEvents() {
        ...
        var e = t._responsiveListeners,
            i = t.platform,
            n = function n(_n33, o) {
          i.addEventListener(t, _n33, o), e[_n33] = o;
        },
            o = function o(n, _o27) {
      ...
      value: function updateHoverStyle(t, e, i) {
        ...
        for ("dataset" === e && (o = this.getDatasetMeta(t[0].datasetIndex), o.controller["_" + n + "DatasetHoverStyle"]()), a = 0, r = t.length; a < r; ++a) {
          ...
          var _e30 = s && this.getDatasetMeta(s.datasetIndex).controller;

          _e30 && _e30[n + "HoverStyle"](s.element, s.datasetIndex, s.index);
        }
      }
    }, {
  ...
  function ho(t) {
    var e = function (t) {
      if (!t._cache.$bar) {
        var _e31 = t.getMatchingVisibleMetas("bar");

        var _i39 = [];

        for (var _n34 = 0, _o28 = _e31.length; _n34 < _o28; _n34++) {
          _i39 = _i39.concat(_e31[_n34].controller.getAllParsedValues(t));
        }

        t._cache.$bar = de(_i39.sort(function (t, e) {
          return t - e;
        }));
      }
  ...
  var bo = /*#__PURE__*/function (_wn) {
    _inherits(bo, _wn);

    var _super4 = _createSuper(bo);
    ...
    _createClass(bo, [{
      ...
      value: function updateElements(t, e, i, n) {
        ...
        for (var _d6 = e; _d6 < e + i; _d6++) {
          var _e32 = o.getParsed(_d6),
              _i40 = s || $(_e32[r.axis]) ? {
            base: l,
            head: l
          } : o._calculateBarValuePixels(_d6),
              _g2 = o._calculateBarIndexPixels(_d6, h),
              _p = (_e32._stacks || {})[r.axis],
              _m = {
            horizontal: c,
            base: _i40.base,
            enableBorderRadius: !_p || go(_e32._custom) || a === _p._top || a === _p._bottom,
            x: c ? _i40.head : _g2.center,
            y: c ? _g2.center : _i40.head,
            height: c ? _g2.size : Math.abs(_i40.size),
            width: c ? Math.abs(_i40.size) : _g2.size
          };
      ...
      value: function _getStacks(t, e) {
        ...
        for (r = 0; r < s; ++r) {
          if (l = n[r], l.controller.options.grouped) {
            if (void 0 !== e) {
              var _t44 = l.controller.getParsed(e)[l.controller._cachedMeta.vScale.axis];

              if ($(_t44) || isNaN(_t44)) continue;
            }
      ...
      value: function _calculateBarValuePixels(t) {
        ...
        if (h = e.chart.getDataVisibility(t) ? i.getPixelForValue(f + g) : m, d = h - m, Math.abs(d) < s && (d = function (t, e, i) {
          ...
          var _t45 = Dt(d) * i.getLineWidthForValue(a) / 2;
      ...
      value: function _calculateBarIndexPixels(t, e) {
        ...
        if (e.grouped) {
          var _n35 = s ? i._getStackCount(t) : e.stackCount,
  ...
  var _o = /*#__PURE__*/function (_wn2) {
    _inherits(_o, _wn2);

    var _super5 = _createSuper(_o);
    ...
    _createClass(_o, [{
      ...
      value: function getMaxOverflow() {
        ...
        for (var _n36 = t.length - 1; _n36 >= 0; --_n36) {
          i = Math.max(i, t[_n36].size() / 2, e[_n36]._custom);
        }
      ...
      value: function updateElements(t, e, i, n) {
        ...
        for (var _l13 = e; _l13 < e + i; _l13++) {
          var _e33 = t[_l13],
              _i41 = !s && o.getParsed(_l13),
              _c13 = {},
              _f2 = _c13[d] = s ? a.getPixelForDecimal(.5) : a.getPixelForValue(_i41[d]),
              _g3 = _c13[u] = s ? r.getBasePixel() : r.getPixelForValue(_i41[u]);

          _c13.skip = isNaN(_f2) || isNaN(_g3), h && (_c13.options = o.resolveDataElementOptions(_l13, _e33.active ? "active" : n), s && (_c13.options.radius = 0)), o.updateElement(_e33, _l13, _c13, n);
        }
  ...
  var yo = /*#__PURE__*/function (_wn3) {
    _inherits(yo, _wn3);

    var _super6 = _createSuper(yo);
    ...
    _createClass(yo, [{
      ...
      value: function _getRotationExtents() {
        ...
        for (var _n37 = 0; _n37 < i.chart.data.datasets.length; ++_n37) {
          if (i.chart.isDatasetVisible(_n37)) {
            var _o29 = i.chart.getDatasetMeta(_n37).controller,
      ...
      value: function updateElements(t, e, i, n) {
        ...
        for (x = e; x < e + i; ++x) {
          ...
          m && (_a20.options = p || o.resolveDataElementOptions(x, _i42.active ? "active" : n)), b += _e34, o.updateElement(_i42, x, _a20, n);
        }
      ...
      value: function getMaxOffset(t) {
        ...
        for (var _i43 = 0, _n38 = t.length; _i43 < _n38; ++_i43) {
          var _t46 = this.resolveDataElementOptions(_i43);

          e = Math.max(e, _t46.offset || 0, _t46.hoverOffset || 0);
        }
    ...
    _createClass(vo, [{
      ...
      value: function updateElements(t, e, i, n) {
        ...
        for (var _c16 = e; _c16 < e + i; ++_c16) {
          var _e35 = t[_c16],
              _i46 = o.getParsed(_c16),
              _g5 = m ? _e35 : {},
              _b2 = $(_i46[f]),
              _2 = _g5[u] = a.getPixelForValue(_i46[u], _c16),
              _y = _g5[f] = s || _b2 ? r.getBasePixel() : r.getPixelForValue(l ? o.applyStack(r, _i46, l) : _i46[f], _c16);

          _g5.skip = isNaN(_2) || isNaN(_y) || _b2, _g5.stop = _c16 > 0 && _i46[u] - x[u] > p, _g5.parsed = _i46, d && (_g5.options = h || o.resolveDataElementOptions(_c16, _e35.active ? "active" : n)), m || o.updateElement(_e35, _c16, _g5, n), x = _i46;
        }
  ...
  var wo = /*#__PURE__*/function (_wn5) {
    _inherits(wo, _wn5);

    var _super8 = _createSuper(wo);
    ...
    _createClass(wo, [{
      ...
      value: function updateElements(t, e, i, n) {
        ...
        for (f = e; f < e + i; f++) {
          ...
          g = _m3, s && (l.animateScale && (_x2 = 0), l.animateRotate && (_i47 = _m3 = u));
          var _b3 = {
            x: h,
            y: d,
            innerRadius: 0,
            ...
            startAngle: _i47,
            endAngle: _m3,
            options: o.resolveDataElementOptions(f, _e36.active ? "active" : n)
          };
          o.updateElement(_e36, f, _b3, n);
        }
      }
    }, {
  ...
  var ko = /*#__PURE__*/function (_wn6) {
    _inherits(ko, _wn6);

    var _super10 = _createSuper(ko);
    ...
    _createClass(ko, [{
      ...
      value: function update(t) {
        ...
        if (n.points = o, "resize" !== t) {
          var _i49 = e.resolveDatasetElementOptions(t);

          e.options.showLine || (_i49.borderWidth = 0);
          var _a22 = {
            _loop: !0,
      ...
      value: function updateElements(t, e, i, n) {
        ...
        for (var _l16 = e; _l16 < e + i; _l16++) {
          var _e37 = t[_l16],
              _i50 = o.resolveDataElementOptions(_l16, _e37.active ? "active" : n),
          ...
          o.updateElement(_e37, _l16, _u6, n);
        }
      }
    }]);
  ...
  function To(t, e, i, n, o) {
    ...
    if (n) {
      var _t47 = ((c > 0 ? c - n : 0) + (h > 0 ? h - n : 0)) / 2;

      u = (f - (0 !== _t47 ? f * _t47 / (_t47 + n) : f)) / 2;
    }
    ...
    if (t.lineTo(O.x, O.y), y > 0) {
      ...
      t.arc(_e39.x, _e39.y, y, m + Mt, C + Math.PI);
    }

    if (t.arc(s, a, d, m - y / d, p + _ / d, !0), _ > 0) {
      var _e40 = Oo(S, D, s, a);

      t.arc(_e40.x, _e40.y, _, D + Math.PI, p - Mt);
    }
  ...
  var Lo = /*#__PURE__*/function (_Mn2) {
    _inherits(Lo, _Mn2);

    var _super12 = _createSuper(Lo);
    ...
    _createClass(Lo, [{
      ...
      value: function draw(t) {
        ...
        if (o) {
          ...
          var _i51 = (e.startAngle + e.endAngle) / 2;

          t.translate(Math.cos(_i51) * a, Math.sin(_i51) * a), e.circumference >= bt && (a = o);
        }
  ...
  function Fo(t, e, i, n) {
    ...
    for (l && (d = o[b(0)], t.moveTo(d.x, d.y)), h = 0; h <= r; ++h) {
      ...
      _n39 === u ? (_i52 < f ? f = _i52 : _i52 > g && (g = _i52), m = (x * m + _e43) / ++x) : (_(), t.lineTo(_e43, _i52), u = _n39, x = 0, f = g = _i52), p = _i52;
    }
  ...
  var No = /*#__PURE__*/function (_Mn3) {
    _inherits(No, _Mn3);

    var _super13 = _createSuper(No);
    ...
    function No(t) {
      ...
      _this8 = _super13.call(this), _this8.animated = !0, _this8.options = void 0, _this8._loop = void 0, _this8._fullLoop = void 0, _this8._path = void 0, _this8._points = void 0, _this8._segments = void 0, _this8._decimated = !1, _this8._pointsUpdated = !1, _this8._datasetIndex = void 0, t && Object.assign(_assertThisInitialized(_this8), t);
      return _this8;
    }
  ...
  var jo = /*#__PURE__*/function (_Mn4) {
    _inherits(jo, _Mn4);

    var _super14 = _createSuper(jo);
  ...
  var Go = /*#__PURE__*/function (_Mn5) {
    _inherits(Go, _Mn5);

    var _super15 = _createSuper(Go);
          ...
          case "lttb":
            u = function (t, e, i, n, o) {
              ...
              for (a[l++] = t[p], h = 0; h < s - 2; h++) {
                ...
                for (_n40 = _c18; _n40 < _m4; _n40++) {
                  _o32 += t[_n40].x, _s20 += t[_n40].y;
                }
                ...
                for (u = f = -1, _n40 = _b4; _n40 < _3; _n40++) {
                  f = .5 * Math.abs((_y2 - _o32) * (t[_n40].y - _v) - (_y2 - t[_n40].x) * (_s20 - _v)), f > u && (u = f, d = t[_n40], g = _n40);
                }
          ...
          case "min-max":
            u = function (t, e, i, n) {
              ...
              for (o = e; o < e + i; ++o) {
                ...
                if (_e45 === l) r < u ? (u = r, c = o) : r > f && (f = r, h = o), g = (p * g + s.x) / ++p;else {
                  var _i54 = o - 1;

                  if (!$(c) && !$(h)) {
                    var _e46 = Math.min(c, h),
                        _n41 = Math.max(c, h);

                    _e46 !== d && _e46 !== _i54 && m.push(_objectSpread(_objectSpread({}, t[_e46]), {}, {
                      x: g
                    })), _n41 !== d && _n41 !== _i54 && m.push(_objectSpread(_objectSpread({}, t[_n41]), {}, {
                      x: g
                    }));
                  }

                  o > 0 && _i54 !== d && m.push(t[_i54]), m.push(s), l = _e45, p = 0, u = f = r, c = h = d = o;
                }
              }
  ...
  function os(t, e, i) {
    for (; e > t; e--) {
      var _t48 = i[e];
      if (!isNaN(_t48.x) && !isNaN(_t48.y)) break;
    }
  ...
  function ss(t) {
    var e = t.chart,
      ...
      for (var _t49 = 0; _t49 < n.length; _t49++) {
        var _o33 = n[_t49];
    ...
    for (var _t50 = 0; _t50 < a.length; _t50++) {
      var _e47 = a[_t50];

      for (var _t51 = _e47.start; _t51 <= _e47.end; _t51++) {
        rs(s, r[_t51], l);
      }
    }
  ...
  function ls(t, e, i) {
    ...
    for (var _t52 = 0; _t52 < s.length; _t52++) {
      var _e48 = s[_t52],
          _n42 = a[_e48.start][i],
          _c19 = a[_e48.end][i];
  ...
  function ms(t, e) {
    var i = e.line,
      ...
      var _iterator21 = _createForOfIteratorHelper(n),
          _step21;

      try {
        for (_iterator21.s(); !(_step21 = _iterator21.n()).done;) {
          var _t53 = _step21.value;
          var _n43 = _t53.start,
              _r14 = _t53.end;
          _r14 = os(_n43, _r14, o);

          var _l18 = us(i, o[_n43], o[_r14], _t53.loop);
          ...
          var _iterator22 = _createForOfIteratorHelper(_c20),
              _step22;

          try {
            for (_iterator22.s(); !(_step22 = _iterator22.n()).done;) {
              var _e49 = _step22.value;

              var _n44 = us(i, s[_e49.start], s[_e49.end], _e49.loop),
                  _r15 = Ii(_t53, o, _n44);

              var _iterator23 = _createForOfIteratorHelper(_r15),
                  _step23;

              try {
                for (_iterator23.s(); !(_step23 = _iterator23.n()).done;) {
                  var _t54 = _step23.value;
                  a.push({
                    source: _t54,
                    target: _e49,
                    start: _defineProperty({}, i, fs(_l18, _n44, "start", Math.max)),
                    end: _defineProperty({}, i, fs(_l18, _n44, "end", Math.min))
                  });
                }
              } catch (err) {
                _iterator23.e(err);
    ...
    try {
      for (_iterator24.s(); !(_step24 = _iterator24.n()).done;) {
        var _step24$value = _step24.value,
            _e50 = _step24$value.source,
            _l19 = _step24$value.target,
            _c21 = _step24$value.start,
            _h15 = _step24$value.end;
        var _e50$style = _e50.style;
        _e50$style = _e50$style === void 0 ? {} : _e50$style;

        var _e50$style$background = _e50$style.backgroundColor,
            _r16 = _e50$style$background === void 0 ? s : _e50$style$background,
            _d11 = !0 !== n;

        t.save(), t.fillStyle = _r16, gs(t, a, _d11 && us(o, _c21, _h15)), t.beginPath();

        var _u8 = !!i.pathSegment(t, _e50);
        ...
        if (_d11) {
          ...
          var _e51 = !!n.pathSegment(t, _l19, {
            move: _u8,
            reverse: !0
          });

          _f5 = _u8 && _e51, _f5 || ps(t, n, _c21, o);
        }
  ...
  var bs = {
    ...
    beforeDraw: function beforeDraw(t, e, i) {
      ...
      for (var _e52 = o.length - 1; _e52 >= 0; --_e52) {
        var _i55 = o[_e52].$filler;
        _i55 && (_i55.line.updateControlPoints(s, _i55.axis), n && xs(t.ctx, _i55, s));
      }
    },
    beforeDatasetsDraw: function beforeDatasetsDraw(t, e, i) {
      ...
      for (var _e53 = n.length - 1; _e53 >= 0; --_e53) {
        var _i56 = n[_e53].$filler;
        _i56 && xs(t.ctx, _i56, t.chartArea);
      }
    },
    ...
    _createClass(ys, [{
      ...
      value: function drawTitle() {
        ...
        if (this.isHorizontal()) g = Math.max.apply(Math, _toConsumableArray(t.lineWidths)), u = t.top + d, f = o(e.align, f, t.right - g);else {
          var _i57 = t.columnSizes.reduce(function (t, e) {
            return Math.max(t, e.height);
          }, 0);

          u = d + o(e.align, t.top, t.bottom - _i57 - e.labels.padding - t._computeTitleHeight());
        }
        var p = o(c, f, f + g);
  ...
  var ws = /*#__PURE__*/function (_Mn7) {
    _inherits(ws, _Mn7);

    var _super17 = _createSuper(ws);
  ...
  var Ps = {
    ...
    nearest: function nearest(t, e) {
      ...
      for (i = 0, n = t.length; i < n; ++i) {
        var _n45 = t[i].element;

        if (_n45 && _n45.hasValue()) {
          var _t56 = Bt(e, _n45.getCenterPoint());

          _t56 < r && (r = _t56, o = _n45);
        }
      }

      if (o) {
        var _t57 = o.tooltipPosition();
  ...
  var Fs = /*#__PURE__*/function (_Mn8) {
    _inherits(Fs, _Mn8);

    var _super18 = _createSuper(Fs);
    ...
    _createClass(Fs, [{
      ...
      value: function update(t, e) {
        ...
        if (o.length) {
          var _t58 = Ps[n.position].call(i, o, i._eventPosition);
          ...
          var _e55 = i._size = Ts(i, n),
              _r19 = Object.assign({}, _t58, _e55),
        ...
        if (o.usePointStyle) {
          var _e56 = {
            ...
            borderWidth: 1
              ...
              _i59 = n.leftForLtr(u, c) + c / 2,
              _s26 = g + l / 2;

          t.strokeStyle = o.multiKeyBackground, t.fillStyle = o.multiKeyBackground, Kt(t, _e56, _i59, _s26), t.strokeStyle = a.borderColor, t.fillStyle = a.backgroundColor, Kt(t, _e56, _i59, _s26);
        } else {
          t.lineWidth = a.borderWidth || 1, t.strokeStyle = a.borderColor, t.setLineDash(a.borderDash || []), t.lineDashOffset = a.borderDashOffset || 0;

          var _e57 = n.leftForLtr(u, c),
              _i60 = n.leftForLtr(n.xPlus(u, 1), c - 2),
          ...
          Object.values(_s27).some(function (t) {
            ...
            h: l - 2,
            radius: _s27
          }), t.fill()) : (t.fillStyle = o.multiKeyBackground, t.fillRect(_e57, g, c, l), t.strokeRect(_e57, g, c, l), t.fillStyle = a.backgroundColor, t.fillRect(_i60, g + 1, c - 2, l - 2));
        }
      ...
      value: function _updateAnimationTarget(t) {
        ...
        if (o || s) {
          var _n46 = Ps[t.position].call(e, e._active, e._eventPosition);

          if (!_n46) return;

          var _a27 = e._size = Ts(e, t),
              _r20 = Object.assign({}, _n46, e._size),
              _l24 = Ls(i, t, _r20),
              _c26 = Rs(t, _r20, _l24, i);

          o._to === _c26.x && s._to === _c26.y || (e.xAlign = _l24.xAlign, e.yAlign = _l24.yAlign, e.width = _a27.width, e.height = _a27.height, e.caretX = _n46.x, e.caretY = _n46.y, e._resolveAnimations().update(e, _c26));
        }
      }
    }, {
      key: "draw",
  ...
  var Bs = {
    ...
    afterEvent: function afterEvent(t, e) {
      if (t.tooltip) {
        var _i61 = e.replay;
        t.tooltip.handleEvent(e.event, _i61) && (e.changed = !0);
      }
    },
    defaults: {
      enabled: !0,
      ...
      callbacks: {
        ...
        title: function title(t) {
          if (t.length > 0) {
            var _e58 = t[0],
                _i62 = _e58.chart.data.labels,
                _n47 = _i62 ? _i62.length : 0;

            if (this && this.options && "dataset" === this.options.mode) return _e58.dataset.label || "";
            if (_e58.label) return _e58.label;
            if (_n47 > 0 && _e58.dataIndex < _n47) return _i62[_e58.dataIndex];
          }
  ...
  var Ns = /*#__PURE__*/function (_En) {
    _inherits(Ns, _En);

    var _super19 = _createSuper(Ns);
  ...
  var js = /*#__PURE__*/function (_En2) {
    _inherits(js, _En2);

    var _super20 = _createSuper(js);
    ...
    _createClass(js, [{
      ...
      value: function handleTickRangeOptions() {
        ...
        if (e) {
          ...
          _t60 < 0 && _e59 < 0 ? r(0) : _t60 > 0 && _e59 > 0 && a(0);
        }

        if (o === s) {
          var _t61 = 1;
          (s >= Number.MAX_SAFE_INTEGER || o <= Number.MIN_SAFE_INTEGER) && (_t61 = Math.abs(.05 * s)), r(s + _t61), e || a(o - _t61);
        }
      ...
      value: function configure() {
        ...
        if (_get2(_getPrototypeOf(js.prototype), "configure", this).call(this), t.options.offset && e.length) {
          var _t62 = (n - i) / Math.max(e.length - 1, 1) / 2;
  ...
  var Us = /*#__PURE__*/function (_En3) {
    _inherits(Us, _En3);

    var _super22 = _createSuper(Us);
  ...
  function Xs(t) {
    ...
    if (e.display && t.display) {
      var _t63 = Be(e.backdropPadding);

      return K(e.font && e.font.size, xt.font.size) + _t63.height;
    }
  ...
  function Js(t, e, i, n) {
    ...
    if (i) o.arc(t.xCenter, t.yCenter, e, 0, _t);else {
      ...
      o.moveTo(_i63.x, _i63.y);

      for (var _s30 = 1; _s30 < n; _s30++) {
        _i63 = t.getPointPosition(_s30, e), o.lineTo(_i63.x, _i63.y);
      }
    }
  }
  ...
  var ea = /*#__PURE__*/function (_js2) {
    _inherits(ea, _js2);

    var _super23 = _createSuper(ea);
    ...
    _createClass(ea, [{
      ...
      value: function drawBackground() {
        ...
        if (e) {
          var _n49 = t.ctx;
          _n49.save(), _n49.beginPath(), Js(t, t.getDistanceFromCenterForValue(t._endValue), i, t.getLabels().length), _n49.closePath(), _n49.fillStyle = e, _n49.fill(), _n49.restore();
        }
      }
    }, {
      key: "drawGrid",
      value: function drawGrid() {
        ...
        if (i.pointLabels.display && function (t, e) {
          ...
          for (var _o38 = e - 1; _o38 >= 0; _o38--) {
            var _e60 = n.setContext(t.getPointLabelContext(_o38)),
                _s31 = Ve(_e60.font),
                ...
                _f8 = _e60.backdropColor;

            if (!$(_f8)) {
              var _t64 = Be(_e60.backdropPadding);

              i.fillStyle = _f8, i.fillRect(_c29 - _t64.left, _h18 - _t64.top, _d14 - _c29 + _t64.width, _u11 - _h18 + _t64.height);
            }
          ...
          if (0 !== i) {
            ...
            var _n50 = o.setContext(t.getContext(i - 1));
      ...
      value: function drawLabels() {
        ...
        e.save(), e.translate(t.xCenter, t.yCenter), e.rotate(o), e.textAlign = "center", e.textBaseline = "middle", t.ticks.forEach(function (o, r) {
          ...
          if (s = t.getDistanceFromCenterForValue(t.ticks[r].value), l.showLabelBackdrop) {
            ...
            var _t65 = Be(l.backdropPadding);

            e.fillRect(-a / 2 - _t65.left, -s - c.size / 2 - _t65.top, a + _t65.width, c.size + _t65.height);
          }
  ...
  function aa(t, e, i, n) {
    ...
    for (var _s33 = na.indexOf(t); _s33 < o - 1; ++_s33) {
      var _t66 = ia[na[_s33]],
          _o40 = _t66.steps ? _t66.steps : Number.MAX_SAFE_INTEGER;

      if (_t66.common && Math.ceil((i - e) / (_o40 * _t66.size)) <= n) return na[_s33];
    }
  ...
  var ca = /*#__PURE__*/function (_En4) {
    _inherits(ca, _En4);

    var _super24 = _createSuper(ca);
      ...
      value: function buildTicks() {
        ...
        return t._unit = i.unit || (n.autoSkip ? aa(i.minUnit, t.min, t.max, t._getLabelCapacity(s)) : function (t, e, i, n, o) {
          for (var _s34 = na.length - 1; _s34 >= na.indexOf(i); _s34--) {
            var _i64 = na[_s34];
            if (ia[_i64].common && t._adapter.diff(o, n, _i64) >= e - 1) return _i64;
          }

          return na[i ? na.indexOf(i) : 0];
        }(t, a.length, i.minUnit, t.min, t.max)), t._majorUnit = n.major.enabled && "year" !== t._unit ? function (t) {
          for (var _e61 = na.indexOf(t) + 1, _i65 = na.length; _e61 < _i65; ++_e61) {
            if (ia[na[_e61]].common) return na[_e61];
          }
  ...
  var da = /*#__PURE__*/function (_ca) {
    _inherits(da, _ca);

    var _super25 = _createSuper(da);
